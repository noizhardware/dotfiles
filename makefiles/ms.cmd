...
@ echo on
gcc -g0 %progName%.c -o %progName%.exe -lm -Wall -Wextra -Wshadow -Werror=implicit-int -Werror=incompatible-pointer-types -Werror=int-conversion -Wvla -pedantic-errors -I %sdlPath% -I %includePath% -L %sdlLib% -lmingw32 -lSDL2main -lSDL2 -mwindows -mconsole -ansi && %progName%.exe
